                        ...
                        <div class="p-6">
                            <form action="{{ route('regions.store') }}" method="POST" class="space-y-5">
                                ...
                                <div class="pt-6 border-t-2 border-p-lt dark:border-p-dark mt-6">
                                    <button type="submit" class="w-full bg-p hover:bg-p-dark text-white border-2 border-black rounded-xl shadow-neo hover:-translate-y-0.5 hover:shadow-neo-lg transition-all flex justify-center items-center gap-2 py-3 text-sm font-black uppercase tracking-wide">
                                ...
                                <tbody class="divide-y-2 divide-p-lt dark:divide-p-dark/30 text-sm">
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-p-dark/20 transition-colors group">
                                        ...
                                        <td class="px-6 py-5 text-right">
                                            <form action="{{ route('regions.destroy', $region->id ?? 0) }}" method="POST" class="inline-block" onsubmit="return confirm('Peringatan: Mencabut izin wilayah akan menghapus akses siswa di kode pos ini. Lanjutkan?');">
                                                @csrf @method('DELETE')
